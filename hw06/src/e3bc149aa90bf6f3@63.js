...
function _public1(__query,FileAttachment,invalidation){return(
__query(FileAttachment("public1.csv"),{from:{table:"public1"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}
...
Plot.plot({
  ...
  color: {
    ...
    range: ['#ff0066', '#ff9999'],  // 你可以根據需要更改顏色
    legend: true
  },
  marks: [
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ...
    ["public1.csv", {url: new URL("./src/public1.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("artist")).define("artist", ["__query","FileAttachment","invalidation"], _artist);
  main.variable(observer("public1")).define("public1", ["__query","FileAttachment","invalidation"], _public1);
